...
MetCriteria | http://purl.imsglobal.org/caliper/actions/MetCriteria | Recipient has met criteria for a BadgeClass and should be awarded a badge. | Yes
...
Requested | http://purl.imsglobal.org/caliper/actions/Requested | Requested a badge object or related resource from an issuer or repository | Yes
...
Displayed | http://purl.imsglobal.org/caliper/actions/Displayed | Displayed badge details on a single badge to a consumer | Yes
...
AssignedTo | http://purl.imsglobal.org/caliper/actions/AssignedTo | Set BadgeClass as related to prospective opportunity, privilege, objective, learning pathway, skill or competency definition | Yes
